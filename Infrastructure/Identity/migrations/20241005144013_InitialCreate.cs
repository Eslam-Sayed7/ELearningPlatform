        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "DOUBLE(10,2)", nullable: false, defaultValueSql: "0.00"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InstructorToCourseId = table.Column<Guid>(type: "TEXT", nullable: false),
                    InstructorId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CourseId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorsToCourse", x => x.InstructorToCourseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorsToCourse_InstructorId",
                table: "InstructorsToCourse",
                column: "InstructorId");
