        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "numeric(10,2)", nullable: false, defaultValueSql: "0.00"),
                    ...
                    LastSectionSequence = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectionSequence = table.Column<int>(type: "INT", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesSections", x => x.SectionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProgressPercentage = table.Column<double>(type: "double precision", nullable: true, defaultValue: 0.0),
            ...
            migrationBuilder.CreateTable(
                name: "InstructorsToCourse",
                columns: table => new
                {
                    InstructorId = table.Column<Guid>(type: "uuid", nullable: false),
                    CourseId = table.Column<Guid>(type: "uuid", nullable: false),
                    InstructorToCourseId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorsToCourse", x => new { x.InstructorId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_InstructorsToCourse_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorsToCourse_Instructors_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Progresses", x => new { x.EnrollmentId, x.SectionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorsToCourse_CourseId",
                table: "InstructorsToCourse",
                column: "CourseId");
